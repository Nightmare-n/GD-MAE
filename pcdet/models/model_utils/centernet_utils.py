...
def decode_bbox_from_heatmap(heatmap, rot_cos, rot_sin, center, center_z, dim, vel=None, iou=None,
    ...
    ious = _transpose_and_gather_feat(iou, inds).view(batch_size, K, 1)
    ...
    for k in range(batch_size):
        ...
        cur_ious = final_ious[k, cur_mask]
